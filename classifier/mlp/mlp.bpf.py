...
def standardize_with_train(X_train_full, mean, std):
...
def main():
    ...
    # X_train_norm = standardize_with_train(X_train, (mean * 2**16).round().astype(np.int64), (std * 2**16).round().astype(np.int64))
