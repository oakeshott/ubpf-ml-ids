...
arg_parser.add_argument('--in-file', type=str, default="dataset/csv/flow/01-12-flow.csv", help='Filename of the dataset')
arg_parser.add_argument('--out-file', type=str, default="dataset/csv/flow/shaped_01-12-flow.csv", help='Filename of the dataset')
...
def main():
    ...
    if args.sampled_indices == None:
        sample_size = int(args.sampling_rate * len(df))
    ...
    sampled_data.to_csv(f"{args.out_file}", index=False)
